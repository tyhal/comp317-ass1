...
public class DecoderShort {
    ...
    public static void main( String[] args ) throws IOException {
    	...
    	DecoderShort decoder = new DecoderShort();
        for( String line = br.readLine(); line != null; line = br.readLine() ) {
            ...
            if( tokens.length == 2 && phrase_num != 0 /* RESET phrase number */ ) { // False when last pair doesn't have mismatch
                decoder.dict.add( new AbstractMap.SimpleEntry< Long, Character >( phrase_num, prefix ) );
            } else if( phrase_num == 0 ) {
                decoder.dict.clear();
            }
